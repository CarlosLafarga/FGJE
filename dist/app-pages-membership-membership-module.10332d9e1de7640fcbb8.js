        ...
        this.membershipService.getCounthelper(iclaveFunSelect, catDisc).subscribe(function (countHelperExp) {
            ...
            if (_this.countHelperExp > 0) {
                ...
                sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()({
                    ...
                    if (result.value) {
                        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()('Confirmado', 'Puede seguir con el proceso.', 'success');
                        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()({
                        ...
                        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.mixin({
                            title: 'Reasignar',
                            ...
                            sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()({
                                ...
                                if (result.value) {
                                    ...
                                    var asignar = new _membership_model__WEBPACK_IMPORTED_MODULE_4__["AsignarPendientes"](catDisc, iclaveFNuevo, iclaveFunSelect);
                                    console.log(asignar);
                                    _this.asignarExpPendientes(asignar);
                                    sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()('Confirmado', 'Los expedientes se han reasignado correctamente.', 'success');
                                }
                                else if (result.dismiss === sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.DismissReason.cancel) {
                                    sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()({
                                        type: 'error',
                            ...
                            sweetalert2__WEBPACK_IMPORTED_MODULE_8___default.a.mixin({
                                ...
                                sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()({
                                    ...
                                    if (result.value) {
                                        ...
                                        var asignar = new _membership_model__WEBPACK_IMPORTED_MODULE_4__["AsignarPendientes"](catDis, iclaveFNuevo, iclaveFAnt);
                                        // console.log(asignar);
                                        _this.asignarExpPendientes(asignar);
                                        sweetalert2__WEBPACK_IMPORTED_MODULE_8___default()('Confirmado', 'Los expedientes se han reasignado correctamente.', 'success');
                                    }
...
//# sourceMappingURL=app-pages-membership-membership-module.10332d9e1de7640fcbb8.js.map