...
var MembershipComponent = /** @class */ (function () {
    ...
    MembershipComponent.prototype.onSubmitExpPend = function () {
        if (this.formExpPend.valid) {
            this.arrayExp = this.selected.map(function (uno) { return uno.expediente_id; });
...
//# sourceMappingURL=app-pages-membership-membership-module.a7f1ba99fe57bf08d46e.js.map