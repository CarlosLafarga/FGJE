...
export class MembershipComponent implements OnInit, OnDestroy {
  ...
  public onSelectRoles(value: number) {
    ...
    if (value == 6 || value == 5) {
      this.loadingIndicator = true;
      this.membershipService.getExpedientesJA(this.catDisGlobal, this.claveglobal).subscribe(data => {
        this.rows = [...data];
      ...
      this.loadingIndicator = true;
      this.membershipService.getExpedientesATP(this.catDisGlobal, this.claveglobal).subscribe(data => {
        this.rows = [...data];
        this.loadingIndicator = false;
